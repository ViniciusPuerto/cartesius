...
ActiveRecord::Schema[8.0].define(version: 2025_08_05_220500) do
  create_schema "tiger"
  ...
  create_table "frames", force: :cascade do |t|
    ...
    t.geometry "shape", limit: {:srid=>0, :type=>"geometry"}, null: false
    t.point "center", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["board_id"], name: "index_frames_on_board_id"
    t.index ["shape"], name: "index_frames_on_shape", using: :gist
  end
